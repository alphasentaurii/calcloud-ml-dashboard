...
def train_models(df, bucket_mod, data_path, opt, mod, verbose, cross_val):
    if mod == "all":
    ...
    for target in models:
        ...
        if cross_val == 'skip':
            ...
            validate.kfold_cross_val(df, target, bucket_mod, data_path, verbose) 
